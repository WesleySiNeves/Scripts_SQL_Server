 ...
 */
IF(NOT EXISTS (
                  SELECT * FROM jobs.target_groups WHERE target_group_name = @targetGroup
              )
  )
    BEGIN
...
EXEC jobs.sp_update_job @job_name = 'Azure-SQL-Automation-DeletarBancosEspelhos',
                        ...
                        @schedule_start_time = N'20210327 04:00'; --N'20210327 04:00' (gtm -3)  =>> 1 da Manha
...
EXEC jobs.sp_update_job @job_name = 'Azure-SQL-Automation-CriarBancosEspelhos',
                        ...
                        @schedule_interval_type = 'Days',
                        @schedule_interval_count = 1,
                        @schedule_start_time = N'20210327 10:00'; --N'20210327 10:00'   (gtm -3)   =>> 7 da Manha
