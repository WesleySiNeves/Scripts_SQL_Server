/****** Object:  StoredProcedure [HealthCheck].[uspDeleteDuplicateIndex]    Script Date: 28/06/2025 09:27:16 ******/
SET ANSI_NULLS ON
GO
...
/* 
Autor: Wesley Neves
Data de Criação: 2018-02-01
Última Atualização: 2025-07-01
Descrição: Procedure  para identificação e remoção inteligente de índices duplicados
...
ALTER   PROCEDURE [HealthCheck].[uspDeleteDuplicateIndex] (
    @Efetivar BIT = 0,
...
      					FORMAT((CASE 
       	              				WHEN d1.IndexSizeKB > d2.IndexSizeKB THEN d1.IndexSizeKB 
       	              				ELSE d2.IndexSizeKB 
       	          				END * 1.2) / 1024.0, 'N1'), ' MB') as EstimatedBenefit
