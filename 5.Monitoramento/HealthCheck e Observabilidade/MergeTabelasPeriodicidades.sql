...
(3, 'CriarStatisticasColunas', 'Criação de estatisticas nas colunas  (Periodicidade =1)', 1, 0, N'2020-10-07',
 N'2021-03-21'),
(4, 'DeletarIndicesDuplicados', 'Deleção de indices duplicados  (Periodicidade =15)', 15, 1, N'2020-10-07', NULL),
...
(13, 'ExpurgarLogsAcesso', 'Expurgar os logs de acesso', 730, 1, N'2021-02-18', NULL),
(14, 'DeletarLogsDuplicados', 'Deletar Logs Duplicados', 7, 1, N'2023-02-28', NULL),
(15, 'ExpurgarSistemaNotificacoes', 'Expurgar a tabela Sistema.Notificacoes', 365, 1, N'2023-12-28', NULL),
(16, 'ExpurgarLogsRelatorios', 'Expurgar os logs de execuções de relatorios', 90, 1, N'2024-01-23',NULL),
(17, 'ExpurgarLogsTasks', 'Expurgar os logs de execuções de logs tasks', 60, 1, N'2024-01-23',NULL);
