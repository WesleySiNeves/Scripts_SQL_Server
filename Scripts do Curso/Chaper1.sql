...
--DROP INDEX CustomerPurchaseOrderNumber ON Sales.Orders
...
SELECT *
FROM   Examples.PurchaseOrders AS PO
WHERE  PO.OrderDate BETWEEN '2016-03-10' AND '2016-03-14';
...
ALTER VIEW Application.PeopleEmployeeStatus
AS
...
CREATE NONCLUSTERED INDEX [IdxInvoicesDate]
...
--DROP INDEX XPKInvoiceCustomerInvoiceAggregates ON Sales.InvoiceCustomerInvoiceAggregates


/*
Tabela 'Invoices'. Contagem de verificações 1, leituras lógicas 153, leituras físicas 0, leituras antecipadas 158, leituras
Tabela 'InvoiceLines'. Contagem de verificações 1, leituras lógicas 5003, leituras físicas 3, leituras antecipadas 4448, le
*/
SET STATISTICS IO ON 
SET STATISTICS TIME ON 
SELECT *
...
SET STATISTICS TIME ON 
/*
Tabela 'InvoiceCustomerInvoiceAggregates'. Contagem de verificações 1, leituras lógicas 7, leituras físicas 0,
*/
SELECT *
FROM   Sales.InvoiceCustomerInvoiceAggregates;
GO
