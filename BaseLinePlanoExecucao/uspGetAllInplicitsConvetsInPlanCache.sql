...
--Autor :Wesley Neves
--Observação:
 https://www.mssqltips.com/sqlservertip/1734/convert-implicit-and-the-related-performance-issues-with-sql-server/
...
CREATE OR ALTER PROCEDURE HealthCheck.uspGetAllInplicitsConvetsInPlanCache
AS 
