...
SELECT 
      ISNULL(P.NomeRazaoSocial,'Grand Total'),
...
ORDER BY P.NomeRazaoSocial DESC ,Quantidade



SELECT 
       ISNULL(P.NomeRazaoSocial,'Total'),
	   Quantidade = COUNT(E.IdEmpenho) ,
...
JOIN Cadastro.Pessoas AS P ON P.IdPessoa = E.IdPessoa
JOIN Contabilidade.PlanoContas AS PC ON PC.IdPlanoConta = E.IdPlanoConta
WHERE E.Exercicio = 2018
AND P.NomeRazaoSocial ='FUNCIONÁRIOS DIVERSOS'
