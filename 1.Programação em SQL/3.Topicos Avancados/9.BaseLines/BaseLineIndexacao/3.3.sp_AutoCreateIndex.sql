                ...
                BEGIN
                    ...
                    IF(EXISTS (SELECT * FROM #Parcial AS P WHERE P.ExisteIndiceNaChave = 1))
                        BEGIN
							...
							--Data: 11/16/2020 
							--Autor :Wesley Neves
							--Observação: Retira as alterações feitas em indice Unique
							 
							-- ==================================================================
							*/
                            DELETE target
                              FROM #Alteracoes AS target
                             WHERE
                                EXISTS (
                                           SELECT I.object_id,
                                                  I.index_id,
                                            ...
                                            WHERE
                                               ...
                                               AND I.object_id = A.ObjectId
                                               AND A.PrimeiraChave = C.name COLLATE DATABASE_DEFAULT
                                       );
